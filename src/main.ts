...
class WebTimeWiseDemo {
  ...
  async init(): Promise<void> {
    console.log('🚀 Initializing WebTimeWise Demo...');
    ...
    console.log('✅ WebTimeWise Demo initialized successfully');
  }
  ...
  destroy(): void {
    ...
    console.log('WebTimeWise Demo destroyed');
  }
}

// Initialize application when DOM is ready
document.addEventListener('DOMContentLoaded', async () => {
  const app = new WebTimeWiseDemo();
  await app.init();
  
  // Make app globally available for debugging
  (window as any).webTimeWiseDemo = app;
});

// Export for module usage
export { WebTimeWiseDemo };