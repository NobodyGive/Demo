// Demo data for WebTimeWise dashboard
...
function loadDemoData(scenario) {
    ...
    localStorage.setItem('webtimewise_timeData', JSON.stringify(demoData.timeData));
    localStorage.setItem('webtimewise_goals', JSON.stringify(demoData.goals));
    localStorage.setItem('webtimewise_categories', JSON.stringify(DEMO_CATEGORIES));
    localStorage.setItem('webtimewise_blockedSites', JSON.stringify(DEMO_BLOCKED_SITES));
    localStorage.setItem('webtimewise_focusBlockList', JSON.stringify(DEMO_FOCUS_BLOCK_LIST));
    
    // Mark as demo data
    localStorage.setItem('webtimewise_demoMode', 'true');
    localStorage.setItem('webtimewise_demoScenario', scenario);
